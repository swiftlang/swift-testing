...
struct SwiftPMTests {
  ...
  func xunitOutputIsWrittenToFile() throws {
    ...
    do {
      ...
      let eventContext = Event.Context(test: nil, testCase: nil, configuration: nil, iteration: nil)
  ...
  func eventStreamOutput<V>(outputArgumentName: String, versionArgumentName: String, version: V.Type) async throws where V: ABI.Version {
    ...
    do {
      ...
      let eventContext = Event.Context(test: test, testCase: nil, configuration: nil, iteration: nil)
