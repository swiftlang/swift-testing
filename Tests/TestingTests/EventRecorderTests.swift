...
struct EventRecorderTests {
  ...
  func junitXMLWithTimelessSkippedTest() async throws {
    ...
    let eventRecorder = Event.JUnitXMLRecorder(writingUsing: stream.write)
    eventRecorder.record(Event(.runStarted, testID: nil, testCaseID: nil), in: Event.Context(test: nil, testCase: nil, configuration: nil, iteration: nil))
    let test = Test {}
    eventRecorder.record(Event(.testSkipped(.init(sourceContext: .init())), testID: test.id, testCaseID: nil), in: Event.Context(test: test, testCase: nil, configuration: nil, iteration: nil))
    eventRecorder.record(Event(.runEnded, testID: nil, testCaseID: nil), in: Event.Context(test: nil, testCase: nil, configuration: nil, iteration: nil))
  ...
  func humanReadableRecorderCountsIssuesWithoutTests() {
    ...
    let context = Event.Context(test: nil, testCase: nil, configuration: nil, iteration: nil)
