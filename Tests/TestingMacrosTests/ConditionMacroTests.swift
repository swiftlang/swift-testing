  ...
  @Test("#expect() macro",
    arguments: [
      ...
      ##"#expect(((true || false) && true) || Bool.random())"##:
        ##"Testing.__checkCondition({ (__ec: inout Testing.__ExpectationContext) in #if canImport(Bool) ((true || false) && true) || Bool.random() #else __ec(__ec((__ec(__ec((__ec(__ec(true, "f7a") || __ec(false, "877a"), "77a")), "7a") && __ec(true, "10003a"), "3a")), "2") || __ec(__ec(Bool.self, "e000000").random(), "2000000"), "") #endif }, sourceCode: ["": "((true || false) && true) || Bool.random()", "2": "((true || false) && true)", "3a": "(true || false) && true", "7a": "(true || false)", "77a": "true || false", "f7a": "true", "877a": "false", "10003a": "true", "2000000": "Bool.random()", "e000000": "Bool"], comments: [], isRequired: false, sourceLocation: Testing.SourceLocation.__here()).__expected()"##,
      ...
      ##"#expect("a" == "b")"##:
        ##"Testing.__checkCondition({ (__ec: inout Testing.__ExpectationContext) in __ec.__cmp({ $0 == $1 }, "", "a", "2", "b", "200") }, sourceCode: ["": #""a" == "b""#], comments: [], isRequired: false, sourceLocation: Testing.SourceLocation.__here()).__expected()"##,
      ##"#expect(!Bool.random())"##:
        ##"Testing.__checkCondition({ (__ec: inout Testing.__ExpectationContext) in #if canImport(Bool) !Bool.random() #else __ec(!__ec(__ec(Bool.self, "1c").random(), "4"), "") #endif }, sourceCode: ["": "!Bool.random()", "4": "Bool.random()", "1c": "Bool"], comments: [], isRequired: false, sourceLocation: Testing.SourceLocation.__here()).__expected()"##,
      ##"#expect((true && false))"##:
  ...
  @Test("#require() macro",
    arguments: [
      ...
      ##"#require(((true || false) && true) || Bool.random())"##:
        ##"Testing.__checkCondition({ (__ec: inout Testing.__ExpectationContext) in #if canImport(Bool) ((true || false) && true) || Bool.random() #else try Testing.__requiringTry(__ec(__ec((__ec(__ec((__ec(__ec(true, "f7a") || __ec(false, "877a"), "77a")), "7a") && __ec(true, "10003a"), "3a")), "2") || __ec(__ec(Bool.self, "e000000").random(), "2000000"), "")) #endif }, sourceCode: ["": "((true || false) && true) || Bool.random()", "2": "((true || false) && true)", "3a": "(true || false) && true", "7a": "(true || false)", "77a": "true || false", "f7a": "true", "877a": "false", "10003a": "true", "2000000": "Bool.random()", "e000000": "Bool"], comments: [], isRequired: true, sourceLocation: Testing.SourceLocation.__here()).__required()"##,
      ...
      ##"#require("a" == "b")"##:
        ##"Testing.__checkCondition({ (__ec: inout Testing.__ExpectationContext) in try Testing.__requiringTry(__ec.__cmp({ $0 == $1 }, "", "a", "2", "b", "200")) }, sourceCode: ["": #""a" == "b""#], comments: [], isRequired: true, sourceLocation: Testing.SourceLocation.__here()).__required()"##,
      ##"#require(!Bool.random())"##:
        ##"Testing.__checkCondition({ (__ec: inout Testing.__ExpectationContext) in #if canImport(Bool) !Bool.random() #else try Testing.__requiringTry(__ec(!__ec(__ec(Bool.self, "1c").random(), "4"), "")) #endif }, sourceCode: ["": "!Bool.random()", "4": "Bool.random()", "1c": "Bool"], comments: [], isRequired: true, sourceLocation: Testing.SourceLocation.__here()).__required()"##,
      ##"#require((true && false))"##:
  ...
  @Test("Unwrapping #require() macro",
    arguments: [
      ...
      ##"#require(123 as? Double)"##:
        ##"Testing.__checkCondition({ (__ec: inout Testing.__ExpectationContext) in try Testing.__requiringTry(__ec.__as(123, "", (Double).self, "20")) }, sourceCode: ["": "123 as? Double", "20": "Double"], comments: [], isRequired: true, sourceLocation: Testing.SourceLocation.__here()).__required()"##,
      ##"#require(123 as Double)"##:
