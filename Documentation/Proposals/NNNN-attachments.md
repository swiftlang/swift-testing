...
As these changes are additive only, the JSON schema version will not be
incremented.
...
<!-- FIXME: get forum/github names right -->

Thanks to @stmontgomery and @briancroom for goading me into finally writing this
proposal!

Thanks to @wil-a-t for his feedback, in particular around `UTType` and MIME type
support.

Thanks to @honza for his earlier work on attachments in XCTest and his ideas on
how to improve Swift Testing's implementation.
