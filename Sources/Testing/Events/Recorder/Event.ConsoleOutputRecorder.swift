...
extension Event.ConsoleOutputRecorder {
  ...
  /// Generate a console-formatted message for the given string and record it as
  /// if it were generated by an event.
  ///
  /// - Parameters:
  ///   - message: The message to record.
  ///   - symbol: The symbol to associate with `message`.
  func record(_ messages: [Event.HumanReadableOutputRecorder.Message]) {
    let lines = _lines(for: messages, tags: nil)
    write(lines.joined())
  }
