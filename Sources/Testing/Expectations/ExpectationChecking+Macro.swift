...
func check<T>(
  _ condition: Bool,
  expectationContext: consuming __ExpectationContext<T>,
...
public func __checkCondition<E>(
  ...
  let expectationContext = __ExpectationContext<Bool>(expressionCapacity: expressionCapacity, sourceCode: sourceCode())
...
public func __checkCondition<T, E>(
  ...
  let expectationContext = __ExpectationContext<T?>(expressionCapacity: expressionCapacity, sourceCode: sourceCode())
...
public func __checkClosureCall<E>(
  ...
  if errorType == Never.self {
    __checkClosureCall(
      throws: Never.self,
      performing: body,
      expressionCapacity: expressionCapacity,
...
public func __checkClosureCall<R>(
  ...
  let expectationContext = __ExpectationContext<(any Error)?>(expressionCapacity: expressionCapacity, sourceCode: sourceCode())
