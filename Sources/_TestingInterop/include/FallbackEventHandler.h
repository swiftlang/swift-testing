...
/// - Note: Because we do not build the `_TestingInterop` library as part of a
///   package build, this header is inaccessible during said build. To solve
///   that problem, we create a symlink to it in the `_TestingInternals` target
///   directory. The symbols in this header can then be accessed from Swift by
///   importing the `_TestingInternals.InteropOnly` submodule.
